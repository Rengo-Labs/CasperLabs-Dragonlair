...
impl ContractContext<OnChainContractStorage> for DragonLair {
    fn storage(&self) -> &OnChainContractStorage {
        &self.0
    }
}
impl ERC20<OnChainContractStorage> for DragonLair {}
impl DRAGONLAIR<OnChainContractStorage> for DragonLair {}
...
fn transfer() {
    ...
    let ret = ERC20::transfer(&mut DragonLair::default(), recipient, amount);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
#[no_mangle]
...
fn transfer_from() {
    ...
    let recipient: Key = runtime::get_named_arg("recipient");
    let amount: U256 = runtime::get_named_arg("amount");
    let ret = ERC20::transfer_from(&mut DragonLair::default(), owner, recipient, amount);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
fn balance_of() {
    let owner: Key = runtime::get_named_arg("owner");
    let ret: U256 = ERC20::balance_of(&mut DragonLair::default(), owner);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
fn nonce() {
    let owner: Key = runtime::get_named_arg("owner");
    let ret: U256 = ERC20::nonce(&mut DragonLair::default(), owner);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
#[no_mangle]
fn name() {
    let ret: String = ERC20::name(&mut DragonLair::default());
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
#[no_mangle]
fn symbol() {
    let ret: String = ERC20::symbol(&mut DragonLair::default());
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
fn allowance() {
    let owner: Key = runtime::get_named_arg("owner");
    let spender: Key = runtime::get_named_arg("spender");
    let ret: U256 = ERC20::allowance(&mut DragonLair::default(), owner, spender);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
#[no_mangle]
fn total_supply() {
    let ret: U256 = ERC20::total_supply(&mut DragonLair::default());
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
...
fn increase_allowance() {
    ...
    let ret: Result<(), u32> =
        ERC20::increase_allowance(&mut DragonLair::default(), spender, amount);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
#[no_mangle]
fn increase_allowance_jsclient() {
    let spender: Key = runtime::get_named_arg("spender");
    let amount: U256 = runtime::get_named_arg("amount");
...
fn decrease_allowance() {
    ...
    let ret: Result<(), u32> =
        ERC20::decrease_allowance(&mut DragonLair::default(), spender, amount);
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
#[no_mangle]
fn decrease_allowance_jsclient() {
    let spender: Key = runtime::get_named_arg("spender");
    let amount: U256 = runtime::get_named_arg("amount");
...
#[no_mangle]
fn package_hash() {
    let ret: ContractPackageHash = ERC20::get_package_hash(&mut DragonLair::default());
    runtime::ret(CLValue::from_t(ret).unwrap_or_revert());
}
